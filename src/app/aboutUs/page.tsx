...
//         <div className="container mx-auto md:grid md:grid-cols-2 md:gap-6   mt-24">
...
//           {/* users review */}
//            {/* add here shadcn crawsel one at a time with responsive with 3 card and infinite loop */}
//         </div>
