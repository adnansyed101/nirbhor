  ...
  return (
    <div className="max-sm:w-11/12 mx-auto mb-3 sm:my-5">
      <div className="flex justify-between gap-5 flex-1">
        <div className="sm:w-[48%] max-sm:flex-1 flex flex-col justify-between max-sm:w-full gap-1">
      ...
      <hr className="my-3 lg:my-5" />
      <div>
        <p className="text-lg font-medium flex max-sm:justify-center items-center gap-2"><Bath className="text-primary w-4" />Amenities:</p>
        <div className="flex gap-10 flex-wrap max-sm:justify-center my-1">
