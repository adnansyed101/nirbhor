...
const BottomBar: React.FC<{ pricePerNight: number, maxGuest: number }> = ({ pricePerNight, maxGuests }) => {
  return (
    <div className="bg-white w-full h-16 sm:h-auto sm:rounded-md sm:py-10 sm:shadow-xs">
      <Container>
